...
The module code is compatible with PHP 7.4 through 8.4. Actual deployable Magento/PHP combinations still depend on Adobe Commerce / Magento Open Source's official platform matrix.
